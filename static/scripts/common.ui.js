    ...
    class Popup {
        constructor(target, obj = {}) {
            ...
            const bind = () => {
                ...
                if (el.$btnClose[0])
                    el.$btnClose.on("click.popup", handler.click);
            ...
            const unbind = () => {
                ...
                if (el.$btnClose[0])
                    el.$btnClose.off("click.popup", handler.click);
                    ...
                    if (el.$popup.is(":visible")) {
                        if (isTooltipType) {
                            ...
                            if (pbut.getDeviceType() === "mobile") {
                                if (pbut.scrollState === false)
                                    pbut.scrollLock();
                            } else {
                                if (pbut.scrollState === true)
                                    pbut.scrollUnLock();
                            }
                        }
                    }
            ...
            const method = {
                ...
                getPosition: () => {
                    ...
                    switch (option.position) {
                        case "top-center":
                            top =
                                realCoord.y - el.$popup.outerHeight() - margin;
                            left =
                                realCoord.x -
                        ...
                        case "middle-left":
                            top =
                                ...
                                el.$opener.outerWidth() / 2;
                            left =
                                realCoord.x - el.$popup.outerWidth() - margin;
                            break;
                        case "middle-right":
                            top =
                                realCoord.y -
                                ...
                                el.$opener.outerWidth() / 2;
                            left =
                                realCoord.x + el.$opener.outerWidth() + margin;
                            break;
                        case "bottom-left":
                            top =
                                realCoord.y + el.$opener.outerHeight() + margin;
                            left = realCoord.x;
                            break;
                        case "bottom-center":
                            top =
    ...
    class Toast {
        constructor(message = "", obj = {}) {
            ...
            const method = {
                render: () => {
                    const $toast = $(
                        '<div class="_toast-message" tabindex="0"></div>',
                    );
        ...
        constructor(target, obj = {}) {
            ...
            const method = {
                render: () => {
                    ...
                    if (!tooltipContent) {
                        tooltipContent =
                            el.$opener.siblings(option.contentClass).html() ||
                            "";
                    }
                ...
                open: () => {
                    ...
                    el.$closeBtn
                        .off("click.tooltip")
                        .on("click.tooltip", handler.click);
    ...
    class Selectmenu {
        constructor(target, obj = {}) {
            ...
            const method = {
                setSelectCont: () => {
                    const $selectCont = $(
                        `#${menuWidget.attr("aria-activedescendant")}`,
                    );
                ...
                setSelectOpen: () => {
                    ...
                    if (pbut.getDeviceType() === "mobile") {
                        ...
                        menuWidget.off("touchstart").on("touchstart", (e) => {
                            ...
                            const startX =
                                touchstartPos.clientX || touchstartPos.pageX;
                            const startY =
                                touchstartPos.clientY || touchstartPos.pageY;
                            ...
                            menuWidget.on("touchmove", (e) => {
                                const touchmovePos =
                                    e.originalEvent.changedTouches[0];
                                const moveX =
                                    touchmovePos.clientX || touchmovePos.pageX;
                                const moveY =
                                    touchmovePos.clientY || touchmovePos.pageY;
                            ...
                            menuWidget.on("touchend", (e) => {
                                ...
                                const touchendPos =
                                    e.originalEvent.changedTouches[0];
                                const endX =
                                    touchendPos.clientX || touchendPos.pageX;
                                const endY =
                                    touchendPos.clientY || touchendPos.pageY;
                                ...
                                if (
                                    ...
                                    menuH / 2 >
                                        menuH - parseInt(menuWidget.css("top"))
                                ) {
                                    if (startY !== endY) {
                                        menuWidget
                                            .stop()
    ...
    const fn_iptSetFocus = function () {
        $(document).on(
            ...
            function () {
                ...
                // input 입력 이벤트
                $input
                    .off("input.iptSetFocus")
                    .on("input.iptSetFocus", function () {
                        $clearBtn.toggle($input.val() !== "");
                    });

                // input blur 시 버튼 제거 (버튼에 포커스 있으면 유지)
                $input
                    .off("blur.iptSetFocus")
                    .on("blur.iptSetFocus", function () {
                        setTimeout(function () {
